...
exports.default = {
  ...
  methods: {
    ...
    train: function train() {
      ...
      this.points.forEach(function (point) {
        return point.predicted = _this.p.train(point.x, point.y, _this.truth(point.x, point.y)) === 0;
      });
      this.$forceUpdate();
      setTimeout(function () {
        if (_this.points.filter(function (point) {
  ...
  mounted: function mounted() {
    this.train();
        ...
        var $a3c658 = exports.default || module.exports;
      
      if (typeof $a3c658 === 'function') {
        $a3c658 = $a3c658.options;
      }
    
        /* template */
        Object.assign($a3c658, (function () {
          var render = function() {
  var _vm = this
  ...
  return _c("div", { attrs: { id: "app" } }, [
    _c(
      "svg",
      { attrs: { width: "500", height: "500", viewBox: "-1 -1 2 2" } },
      [
        _vm._l(_vm.points, function(point) {
          return _c("circle", {
            attrs: {
              cx: point.x,
              cy: point.y,
              fill: _vm.fun(point.x) > point.y ? "red" : "green",
    ...
    (function () {
      if (module.hot) {
        ...
        if (api.compatible) {
          module.hot.accept();
          if (!module.hot.data) {
            api.createRecord('$a3c658', $a3c658);
          } else {
            api.reload('$a3c658', $a3c658);
          }
        }
...
},{"./Perceptron":14,"_css_loader":16,"vue-hot-reload-api":17,"vue":6}],4:[function(require,module,exports) {
'use strict';
...
//# sourceMappingURL=/main.98854f03.map